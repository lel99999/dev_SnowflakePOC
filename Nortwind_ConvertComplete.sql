...
--    customer_id bpchar NOT NULL,
--    customer_id char NOT NULL, Modified b/c sizing error
...
CREATE TABLE IF NOT EXISTS orders (
    order_id smallint NOT NULL,
--    customer_id bpchar,
--    customer_id char, Changed to match customers table
...
--    region_description char NOT NULL -- change char to varchar(20) address size error
...
--    territory_description char NOT NULL, -- change char to varchar(20) to address size error
